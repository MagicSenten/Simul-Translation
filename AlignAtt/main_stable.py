...
def parse_args():
    ...
    parser.add_argument("--num_beams", type=int, default=1, help="Setting the num_beams to a multiple of three turns on diverse beam search with num_beams//3 groups.")
...
def main():
    ...
    if args.isLLM:
        raise Exception("LLM not supported here")
    else:
