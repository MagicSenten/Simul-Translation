...
data = {os.path.splitext(os.path.basename(x[1]))[0]: x[0] for x in data}
...
make_table(["bleu", "word error rate", "average lagging", "num_beams","wait_for_beginning", "halfway example", "full example"], data)

make_table(["bleu", "word error rate", "average lagging", "num_beams","wait_for_beginning"], data)